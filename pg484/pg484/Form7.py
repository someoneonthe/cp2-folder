...
class Form7(Form):
	...
	def InitializeComponent(self):
		...
		self._label4.Text = "Uranus Jovian"
		# 
		# label3
		# 
		...
		self._label3.Text = "Temperacher: -220C"
		# 
		# label2
		# 
		...
		self._label2.Text = "Mass: 8.69  x 10^25"
		# 
		# label1
		# 
		...
		self._label1.Text = "Distance: 19.18 AU"
		# 
		# button1
		# 
		...
		# Form7
		# 
		self.ClientSize = System.Drawing.Size(237, 162)
