...
class Form2(Form):
	...
	def InitializeComponent(self):
		...
		self._label3.Size = System.Drawing.Size(199, 32)
		self._label3.TabIndex = 7
		self._label3.Text = "Temperacher: 472"
		# 
		# label2
		# 
		...
		self._label2.Text = "Mass: 4.78 x 10^24"
		# 
		# label1
		# 
		...
		self._label1.Text = "distance: 0.7233 AU"
		# 
		# button1
		# 
		...
		# label4
		# 
		self._label4.Location = System.Drawing.Point(159, 9)
		self._label4.Name = "label4"
		self._label4.Size = System.Drawing.Size(111, 51)
		self._label4.TabIndex = 8
		self._label4.Text = "Venus Terrestrial"
		# 
		# Form2
		# 
		self.ClientSize = System.Drawing.Size(294, 161)
