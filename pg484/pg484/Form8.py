...
class Form8(Form):
	...
	def InitializeComponent(self):
		...
		self._label4.TabIndex = 37
		self._label4.Text = "Neptune Jovian"
		# 
		# label3
		# 
		...
		self._label3.Text = "Temperacher: -216C"
		# 
		# label2
		# 
		...
		self._label2.TabIndex = 35
		self._label2.Text = "Mass: 1.03  x 10^26"
		# 
		# label1
		# 
		...
		self._label1.TabIndex = 34
		self._label1.Text = "Distance: 30.0611 AU"
		# 
		# button1
		# 
		...
		# Form8
		# 
		self.ClientSize = System.Drawing.Size(234, 160)
