...
class Form9(Form):
	...
	def InitializeComponent(self):
		...
		self._label4.Location = System.Drawing.Point(135, 9)
		self._label4.Name = "label4"
		self._label4.Size = System.Drawing.Size(119, 51)
		self._label4.TabIndex = 42
		self._label4.Text = "Pluto     low dencity"
		# 
		# label3
		# 
		...
		self._label3.Text = "Temperacher: -230C"
		# 
		# label2
		# 
		...
		self._label2.TabIndex = 40
		self._label2.Text = "Mass: 1.2  x 10^22"
		# 
		# label1
		# 
		...
		self._label1.TabIndex = 39
		self._label1.Text = "Distance: 39.44 AU"
		# 
		# button1
		# 
		...
		# Form9
		# 
		self.ClientSize = System.Drawing.Size(247, 162)
